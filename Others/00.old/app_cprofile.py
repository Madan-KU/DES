...
#         plt.plot(resource_data['Day'], resource_data['Daily_Use'], label=f'{resource} Usage')

#         # Calculate and plot the mean line
#         mean_use = resource_data['Daily_Use'].mean()
#         plt.axhline(mean_use, color='red', linestyle='--', linewidth=2, alpha=0.7, 
#                     label=f'{resource} Mean Usage')
...
#     for resource in data['Resource'].unique():
#         resource_data = data[data['Resource'] == resource]
#         plt.plot(resource_data['Day'], resource_data['Queue_Length'], label=f'{resource} Queue Length')

#         # Calculate and plot the mean line
#         mean_queue = resource_data['Queue_Length'].mean()
#         plt.axhline(mean_queue, color='green', linestyle='--', linewidth=2, alpha=0.7, 
#                     label=f'{resource} Mean Queue Length')
    # plt.xlabel('Day')
